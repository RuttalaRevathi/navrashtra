...
const DeeplinkingDetails = ({navigation, route}) => {
  ...
  const handleWebViewRequest = request => {
    ...
    console.log(url, 'url inside handleWebViewRequest');

    if (url.includes('post_id=')) {
      // Extract the post_id from the URL
      let postId = url.split('post_id=')[1];
      console.log(postId, 'inside handleWebViewRequest');
        ...
        <View>
          <View
            ...
            <View style={{paddingLeft: 10, paddingTop: 10}}>
              <Text
                ...
                {console.log(
                  ...
                  'firstArticle?.title?.rendered in side text component',
                )}
              </Text>
            </View>
            {/* Time */}
            ...
            <View
              ...
              {renderWebView &&
                (console.log(source1, 'content in details'),
                (
                  <AutoHeightWebView
...
export default DeeplinkingDetails;
